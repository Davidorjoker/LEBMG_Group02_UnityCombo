...
function scene:create( event )
    ...
    local bg = display.newImageRect( "texture/StartBackground.jpg", 480, 320 )
    local bg1 = display.newImageRect( "texture/StartBackground.jpg", 480, 320 )
       bg.anchorX = 0
       bg.x = 0
       bg.y = centerY
       bg.speed = 1 --新增速度
    ...
    --標題Ｘ位置,Ｙ位置,內容
    title = titleFont:newBitmapString(centerX,0, "Unity Combo" )
    ...
    menuPlay.name="play"
    local menuExit= menuFont:newBitmapString(0,centerY*1.6, "Quit" )
    menuExit.name="exit"
